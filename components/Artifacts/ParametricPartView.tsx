    ...
    <div className="flex flex-col h-full bg-white font-sans">
      ...
      <div className="p-6 border-b border-gray-200 bg-gray-50">
        <div className="flex justify-between items-start">
            ...
            <div className="flex gap-2">
                {data.datasheetUrl && (
                    <a href={data.datasheetUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1 px-3 py-2 bg-white border border-gray-300 rounded-lg text-xs font-bold text-gray-600 hover:text-brand-blue hover:border-brand-blue transition-colors">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
        <div className="flex items-center gap-2 mb-4">
            ...
            <span className="bg-brand-lightBlue text-brand-blue text-[10px] px-2 py-0.5 rounded-full font-bold">LIVE DATA</span>
        </div>
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50">
        <button 
            ...
            className="w-full py-3 bg-brand-blue text-white rounded-lg font-bold shadow-md hover:bg-blue-700 transition-all flex items-center justify-center gap-2"
        >
            <Search size={18} />
            Find Similar Parts
        </button>
